...
//Percentage ranges from 0.00 to 1.00
bool setPosition(double percent) {
  int position = (int) (maxPulses * percent);
  bool incomplete = false;

  if (abs(numPulsesA - position) <= 5) {
    Set_PWMA(0);
  }
